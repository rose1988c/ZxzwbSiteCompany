<div class="header navbar navbar-inverse navbar-fixed-top">
	...
	<div class="navbar-inner">
		<div class="container-fluid">
			<!-- BEGIN LOGO -->
			<a class="brand" href="/manage/"> <img
				src="/www/img/metronic/logo.png" alt="logo" />
			</a>
			<!-- END LOGO -->
			<!-- BEGIN RESPONSIVE MENU TOGGLER -->
			<a href="javascript:;" class="btn-navbar collapsed"
				data-toggle="collapse" data-target=".nav-collapse"> <img
				src="/www/img/metronic/menu-toggler.png" alt="" />
			</a>
			...
			<ul class="nav pull-right">
				...
				<li class="dropdown" id="header_notification_bar"><a href="#"
					...
					<ul class="dropdown-menu extended notification">
						...
						<li><a href="#"> <span class="label label-important"><i
									class="icon-bolt"></i></span> 2 user IP blocked. <span
								class="time">5 hrs</span>
						</a></li>
				...
				<li class="dropdown" id="header_inbox_bar"><a href="#"
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="inbox.html/a=view"> <span class="photo"><img
									src="/www/img/metronic/avatar2.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html/a=view"> <span class="photo"><img
									src="/www/img/metronic/avatar3.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html/a=view"> <span class="photo"><img
									src="/www/img/metronic/avatar1.jpg" alt="" /></span> <span
				...
				<li class="dropdown" id="header_task_bar"><a href="#"
					...
					<ul class="dropdown-menu extended tasks">
						...
						<li><a href="#"> <span class="task"> <span class="desc">New
						...
						<li><a href="#"> <span class="task"> <span class="desc">Application
								...
								class="progress progress-danger progress-striped active"> <span
